...
class JointModel(pl.LightningModule):
    def __init__(self, args):
        ...
        if os.path.exists(args.pretrained_path):
            ...
            print(f"Weights not found at {args.pretrained_path}!")
    ...
    def encode_batch(self, batch, reduce):
        ...
        output_obs = torch.cat([output_obs, output_1d_obs], dim=2)
        output_int = torch.cat([output_int, output_1d_int], dim=2)
